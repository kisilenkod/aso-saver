...
export default function Sidebar({ apps, selectedAppId, onSelectApp, onAddApp, onDeleteApp, isOpen, onToggle }: Props) {
          ...
          apps.map(app => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {app.bundleId && (
                  <p className="text-xs text-gray-500 truncate">{app.bundleId}</p>
                )}
              </div>
              <button
